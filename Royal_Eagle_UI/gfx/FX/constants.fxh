...
//c static const float  MAP_AMBIENT					= 0.0f;
static const float  MAP_AMBIENT					= 0.15f;
...
//c static const float 	WATER_TILE					= 1.0f;
static const float 	WATER_TILE					= 0.8f;
//c static const float 	WATER_TIME_SCALE			= 12.0f;
static const float 	WATER_TIME_SCALE			= 8.0f;
